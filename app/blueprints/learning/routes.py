...
def toeic():
    ...
    return render_template("learning/toeic_list.html", tests=tests, attempts=attempts, best_scores=best_scores)
...
def toeic_start(test_id):
    ...
    db.session.add(attempt)
    db.session.commit()
    return redirect(url_for("learning.toeic_attempt", attempt_id=attempt.id))
...
def toeic_attempt(attempt_id):
    ...
    if attempt.is_submitted:
        return redirect(url_for("learning.toeic_result", attempt_id=attempt.id))
