...
class Vocabulary(db.Model):
    ...
    category = db.Column(db.String(50), nullable=False, default="CEFR", index=True)
    subcategory = db.Column(db.String(100), nullable=True, index=True)
    lesson_unit = db.Column(db.String(100), nullable=True, index=True)
    topic = db.Column(db.String(80), nullable=False, index=True)
    level = db.Column(db.String(10), nullable=False, default="A1", index=True)
...
class VocabularyProgress(db.Model):
    ...
    srs_level = db.Column(db.Integer, nullable=False, default=1)
